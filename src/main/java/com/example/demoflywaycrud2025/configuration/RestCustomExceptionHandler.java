...
public class RestCustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private record ValidationErrorDTO(String field, String error) {
     ...
     ///Contack Already Exist Exception
    @ExceptionHandler(ContactAlreadyExistsException.class)
    public ProblemDetail handleContactAlreadyExistsException(final ContactAlreadyExistsException ex) {
        log.error("ContactAlreadyExistsException with status {} occurred.", HttpStatus.CONFLICT, ex);

        ProblemDetail problemDetail = ProblemDetail.forStatus(HttpStatus.BAD_REQUEST);
        problemDetail.setDetail(ex.getMessage());
        problemDetail.setType(URI.create("/api/contacts"));
        problemDetail.setTitle("Contact Already Exists");
